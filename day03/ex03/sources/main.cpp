...
/*   Updated: 2022/11/03 22:54:31 by bpoetess         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
int	main()
{
	...
	std::cout << std::endl;
	{
		DiamondTrap	diamontTrap("Trap_DiamondTrap");

		diamontTrap.guardGate();
		diamontTrap.highFivesGuys();
		diamontTrap.whoAmI();
		diamontTrap.attack("kris_vanuchiy");
		diamontTrap.takeDamage(10);
		diamontTrap.beRepaired(15);
		diamontTrap.takeDamage(5);
		diamontTrap.beRepaired(20);
		diamontTrap.takeDamage(35);
		diamontTrap.takeDamage(10);
		diamontTrap.beRepaired(8);
	}
	return (0);
}